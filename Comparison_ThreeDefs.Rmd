...
---
title: "Definition Comparison: `r def1_name`, `r def2_name`, and `r def3_name`"
...
DT::datatable(def3_structure, rownames = FALSE, options = list(pageLength = nrow(def3_structure), dom = "t"), filter = "top", escape = FALSE)
...
subplot(ts_plot_def1, ts_plot_def2, ts_plot_def3, nrows = 3, shareX = TRUE)
...
# All Visits
write.csv(file = "Output (ThreeDefs)/Three Defs All Visits.csv",
          x = three_defs_table,
          row.names = FALSE)

# Def1 only
write.csv(file = paste0("Output (ThreeDefs)/",def1_short," Only Visits.csv"),
          x = three_defs_table[three_defs_table$def1_only==1,],
          row.names = FALSE)

# Def2 only
write.csv(file = paste0("Output (ThreeDefs)/",def2_short," Only Visits.csv"),
          x = three_defs_table[three_defs_table$def2_only==1,],
          row.names = FALSE)

# Def3 only
write.csv(file = paste0("Output (ThreeDefs)/",def3_short," Only Visits.csv"),
          x = three_defs_table[three_defs_table$def3_only==1,],
          row.names = FALSE)

# Def1 and Def2 
write.csv(file = paste0("Output (ThreeDefs)/",def1_short," and ",def2_short," Visits.csv"),
          x = three_defs_table[three_defs_table$def1_def2==1,],
          row.names = FALSE)

# Def1 and Def3 
write.csv(file = paste0("Output (ThreeDefs)/",def1_short," and ",def3_short," Visits.csv"),
          x = three_defs_table[three_defs_table$def1_def3==1,],
          row.names = FALSE)

# Def2 and Def3 
write.csv(file = paste0("Output (ThreeDefs)/",def2_short," and ",def3_short," Visits.csv"),
